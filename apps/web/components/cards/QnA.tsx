...
const QnA = ({onClick} : {onClick: () => void}) => {
    ...
    return (
        ...
        className='my-2'>
            ...
            <div className='flex justify-between items-center mt-2 shadow-[0px_0px_2px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] p-4 border border-secondary rounded-sm cursor-pointer'>
